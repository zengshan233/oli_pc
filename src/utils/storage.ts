...
const SessionStorageService = storageUtil(window.sessionStorage || sessionStorage)
const LocalStorageService = storageUtil(window.localStorage || localStorage)
